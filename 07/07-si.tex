...
\item \uv{Přivlastním} si bug, přiřadím ho k sobě (změní se stav ticketu) a tím dam ostatním vývojářům vědět, že tento bug již řešit nemusí.
...
\item Pak buď vytvořím pull request, nebo vytvořím patch soubor, který připojím k ticketu bugu. Změním stav ticketu na \uv{fixnuto}, tím dám echo, že bug je z mé strany splněn.
