...
\begin{document}
    ...
    \include{01/01-si} % TPJ
    \include{02/02-si} % TPJ
    \include{03/03-si} % NUR
    \include{04/04-si} % NUR
    \include{05/05-si} % NUR
    \include{06/06-si} % NUR
    \include{07/07-si} % OSP
    \include{08/08-si} % OSP
    \include{09/09-si} % AOS
    \include{10/10-si} % AOS
    \include{11/11-si} % AOS
    \include{12/12-si} % AOS
    \include{13/13-si} % TVS
    \include{14/14-si} % TVS
    \include{15/15-si} % TVS
    \include{16/16-si} % WA2
    \include{17/17-si} % WA2
    \include{19/19-si} % WA2
